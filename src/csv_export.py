...
_LINE_CSV_COLUMNS = [
    ...
    # applied factors (+ missing-MFC flags: CODE_MISSING = no code on the line,
    # updated cost 0; FACTOR_MISSING = code present, no EMMA factor, kept 1.0)
    COL_BASE_MATERIAL_MFC, COL_BASE_MATERIAL_FACTOR,
    COL_BASE_MATERIAL_CODE_MISSING, COL_BASE_MATERIAL_FACTOR_MISSING,
    COL_VENDOR_SHOP_FAB_MFC, COL_VENDOR_SHOP_FAB_FACTOR,
    COL_VENDOR_SHOP_FAB_CODE_MISSING, COL_VENDOR_SHOP_FAB_FACTOR_MISSING,
